...
namespace GenTestProject2.ComplexContracts
{
    ...
    /// </summary>
    public partial interface IDpadThemeByItem
    {
        /// <summary>
    ...
    /// <summary>
    /// Dpad instance DpadTheme.
    /// </summary>
    internal partial class DpadTheme
    {
    ...
    /// DpadTheme
    /// </summary>
    public partial interface IDpadTheme : IDpadThemeByItem
    {
    ...
    /// <param name="dpadtheme">The <see cref="IDpadTheme"/> on which to apply the feedback.</param>
    public delegate void DpadThemeBoolInputSigDelegate(BoolInputSig boolInputSig, IDpadTheme dpadtheme);

    /// <summary>
    /// DpadTheme
    /// </summary>
    internal partial class DpadTheme : IDpadTheme, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: ComplexContracts.DpadTheme.Up
                /// Up.Press
                /// </summary>
                public const uint UpEvent = 3;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: ComplexContracts.DpadTheme.Down
                /// Down.Press
                /// </summary>
                public const uint DownEvent = 4;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: ComplexContracts.DpadTheme.Left
                /// Left.Press
                /// </summary>
                public const uint LeftEvent = 5;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: ComplexContracts.DpadTheme.Right
                /// Right.Press
                /// </summary>
                public const uint RightEvent = 6;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: ComplexContracts.DpadTheme.Center
                /// Center.Press
                /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DpadTheme"/> component class.
        /// </summary>
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        /// <param name="itemCount">The number of items.</param>
        internal DpadTheme(ComponentMediator componentMediator, uint controlJoinId, uint? itemCount)
        {
        ...
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        internal DpadTheme(ComponentMediator componentMediator, uint controlJoinId) : this(componentMediator, controlJoinId, null)
        {
        }
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "DpadTheme", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
